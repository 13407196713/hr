...
public class ApplicantDaoImpl implements ApplicantDao {
	...
	public void saveApplicant(Applicant applicant) {
		...
		Object[] params = new Object[]{applicant.getName(),applicant.getSex(),applicant.getAge(),applicant.getJob(),applicant.getSpecialty(), applicant.getExperience(),applicant.getStudyeffort(),applicant.getSchool(),applicant.getTel(),applicant.getEmail(),applicant.getCreatetime(),applicant.getContent(),applicant.getIsstock()};
		try {
