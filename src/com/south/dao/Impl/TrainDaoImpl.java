...
public class TrainDaoImpl implements TrainDao {
	...
	public void save(Train train) {
		...
		Object[] params = new Object[]{train.getName(),train.getPurpose(),train.getBegintime(),train.getEndtime(), train.getDatum(),train.getTeacher(),train.getStudent(),train.getEducate()};
		try {
