...
public class Applicant {
    ...
    public Applicant(Long id,String name, String sex, Integer age, String job, String specialty, String experience, String studyeffort, String school, String tel, String email, Date createtime, String content, Byte isstock) {
        this.id=id;
        this.name = name;
        this.sex = sex;
        this.age = age;
