...
public class Train {
	...
	public Train(String name, String purpose, Date begintime, Date endtime, String datum, String teacher, String student, Date createtime, Byte educate, String effect, String summarize) {
		this.name = name;
