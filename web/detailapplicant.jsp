...
<%@ page import="com.south.pojo.Applicant"%>
...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr><th class="tablestyle_title" >人才详细信息</th></tr>

  <tr>
    <td class="CPanel">
		<table border="0" cellpadding="0" cellspacing="0" style="width:80%" align="center">
		<%
		Applicant j=(Applicant)request.getAttribute("applicant");
		 	if(j!=null){
		%>
		<tr>
			<td width="100%">
				...
				<table border="0" cellpadding="8" cellspacing="1" style="width:100%">
					  <tr>
						<td align="right" width="9%">id：</td>
						<td width="36%"><%=j.getId()%></td>
					  </tr>
					  <tr>
						<td align="right" width="9%">姓名：</td>
						<td width="36%"><%=j.getName()%></td>
						<td width="20%"><div align="right">性别：</div></td>
						<td width="43%"><%=new String("男").equals(j.getSex())?"男":"女"%>
					  </tr>
					  <tr>
