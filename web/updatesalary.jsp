...
<%@ page import="com.south.pojo.Salary"%>
...
<form name="stipendForm" method="post" action="SalaryServlet?method=salaryUpdate" onsubmit="return salaryValidate();">
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
	...
	<%
	  Salary e=(Salary)request.getAttribute("salary");
	  if(e!=null){
	%>
  <tr>
    <td class="CPanel">
