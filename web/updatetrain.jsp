...
<%@ page import="com.south.pojo.Train"%>
...
<form name="educateForm" method="post" action="TrainServlet?method=updateTrain" onSubmit="return educateValidate();">
<div class="MainDiv">
    ...
    <td class="CPanel">
		...
		Train e=(Train)request.getAttribute("train");
	  	...
	  	<input type="hidden" name="id" value="<%=e.getId()%>"/>
	   	<input type="hidden" name="educate" value="1"/> 
		<TR>
			<TD width="100%">
