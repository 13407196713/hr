...
<%@ page import="com.south.utils.*"%>
<%@ page import="com.south.pojo.User"%>
...
<form name="userForm" method="post" action="UserServlet?method=updateUser" onSubmit="return userValidate();"> // onSubmit="return userValidate();
<div class="MainDiv">
				...
				<fieldset style="height:100%;">
					<legend>人员信息</legend>
					  ...
					  <tr>
						...
						<td width="36%">
							<input name="username" type="text" class="input" id="username" value="<%=u.getUsername()%>">
							<span class="red">*</span>
						</td>

						<td width="12%"><div align="right">登陆密码：</div></td>
						<td width="43%">
							<input name="password" type="text" class="input" id="password" value="<%=u.getPassword()%>"/>
							<span class="red">*</span>
						</td>
					  ...
					  <tr>
						...
						<td>
							<input name="sex" type="radio" value="男" <%=new String("男").equals(u.getSex())?"checked":""%>>男
							<input name="sex" type="radio" value="女" <%=new String("女").equals(u.getSex())?"checked":""%>>女
						</td>
						<td><div align="right">出生日期：</div></td>
						<td>
							<input name="birthday" type="text" class="input" id="birthday" value="<%=StringUtil.notNull(DateUtil.parseToString(u.getBirthday(),DateUtil.yyyyMMdd))%>">
							<span class="red">*</span>
						</td>
					  </tr>
						<%--   <tr>
